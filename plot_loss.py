...
train = np.load('/home/caffe_snapshot/T6/all_10e-4/train_loss_data_sketches.npy')
test = np.load('/home/caffe_snapshot/T6/all_10e-4/test_loss_data_sketches.npy')
#accu = np.load('/home/caffe_snapshot/accuracy_data_sketches.npy')

niter=train.shape[0]
#test = test[:4500/50]
test_iter=50#niter/test.shape[0]
train_iter=10
