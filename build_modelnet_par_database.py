...
path_out = '/home/rendus/modelnet_out/test/'
#name = 'irons'

files = glob.glob(path_in+'/depth/*.png')[begin:begin+max_size]
...
for i in range(int(nb_batch)):
    with h5py.File(train_filename+str(int(i+id_batch*nb_batch))+'.h5', 'w') as f:
